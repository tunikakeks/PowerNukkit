...
public class BossEventPacket extends DataPacket {
    ...
    @Since("FUTURE") public static final int TYPE_UPDATE_PROPERTIES = 6;
    @PowerNukkitOnly("Renamed by cloudburst")
    @Deprecated
    @DeprecationDetails(by = "Cloudburst", reason = "Renamed", replaceWith = "TYPE_UPDATE_PROPERTIES", since = "FUTURE")
