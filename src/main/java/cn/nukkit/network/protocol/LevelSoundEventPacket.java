...
public class LevelSoundEventPacket extends DataPacket {
    ...
    @PowerNukkitOnly @Since("FUTURE") public static final int SOUND_BABY_SPAWN = 222;
    ...
    @PowerNukkitOnly @Since("FUTURE") public static final int SOUND_TURTLE_LAY_EGG = 227;
    ...
    @Since("FUTURE") public static final int SOUND_ITEM_SHIELD_BLOCK = 255;
    @Since("FUTURE") public static final int SOUND_ITEM_BOOK_PUT = 256;
    @Since("FUTURE") public static final int SOUND_BLOCK_GRINDSTONE_USE = 257;
    @Since("FUTURE") public static final int SOUND_BLOCK_BELL_HIT = 258;
    @Since("FUTURE") public static final int SOUND_BLOCK_CAMPFIRE_CRACKLE = 259;
    @Since("FUTURE") public static final int SOUND_ROAR = 260;
    @Since("FUTURE") public static final int SOUND_STUN = 261;
    @Since("FUTURE") public static final int SOUND_BLOCK_SWEET_BERRY_BUSH_HURT = 262;
    @Since("FUTURE") public static final int SOUND_BLOCK_SWEET_BERRY_BUSH_PICK = 263;
    @Since("FUTURE") public static final int SOUND_BLOCK_CARTOGRAPHY_TABLE_USE = 264;
    @Since("FUTURE") public static final int SOUND_BLOCK_STONECUTTER_USE = 265;
    @Since("FUTURE") public static final int SOUND_BLOCK_COMPOSTER_EMPTY = 266;
    @Since("FUTURE") public static final int SOUND_BLOCK_COMPOSTER_FILL = 267;
    @Since("FUTURE") public static final int SOUND_BLOCK_COMPOSTER_FILL_SUCCESS = 268;
    @Since("FUTURE") public static final int SOUND_BLOCK_COMPOSTER_READY = 269;
    @Since("FUTURE") public static final int SOUND_BLOCK_BARREL_OPEN = 270;
    @Since("FUTURE") public static final int SOUND_BLOCK_BARREL_CLOSE = 271;
    @Since("FUTURE") public static final int SOUND_RAID_HORN = 272;
    @Since("FUTURE") public static final int SOUND_BLOCK_LOOM_USE = 273;
    @Since("FUTURE") public static final int SOUND_AMBIENT_IN_RAID = 274;
    @Since("FUTURE") public static final int SOUND_UI_CARTOGRAPHY_TABLE_TAKE_RESULT = 275;
    @Since("FUTURE") public static final int SOUND_UI_STONECUTTER_TAKE_RESULT = 276;
    @Since("FUTURE") public static final int SOUND_UI_LOOM_TAKE_RESULT = 277;
    @Since("FUTURE") public static final int SOUND_BLOCK_SMOKER_SMOKE = 278;
    @Since("FUTURE") public static final int SOUND_BLOCK_BLASTFURNACE_FIRE_CRACKLE = 279;
    @Since("FUTURE") public static final int SOUND_BLOCK_SMITHING_TABLE_USE = 280;
    @Since("FUTURE") public static final int SOUND_SCREECH = 281;
    @Since("FUTURE") public static final int SOUND_SLEEP = 282;
    @Since("FUTURE") public static final int SOUND_BLOCK_FURNACE_LIT = 283;
    @Since("FUTURE") public static final int SOUND_CONVERT_MOOSHROOM = 284;
    @Since("FUTURE") public static final int SOUND_MILK_SUSPICIOUSLY = 285;
    @Since("FUTURE") public static final int SOUND_CELEBRATE = 286;
    @Since("FUTURE") public static final int SOUND_JUMP_PREVENT = 287;
    @Since("FUTURE") public static final int SOUND_AMBIENT_POLLINATE = 288;
    @Since("FUTURE") public static final int SOUND_BLOCK_BEEHIVE_DRIP = 289;
    @Since("FUTURE") public static final int SOUND_BLOCK_BEEHIVE_ENTER = 290;
    @Since("FUTURE") public static final int SOUND_BLOCK_BEEHIVE_EXIT = 291;
    @Since("FUTURE") public static final int SOUND_BLOCK_BEEHIVE_WORK = 292;
    @Since("FUTURE") public static final int SOUND_BLOCK_BEEHIVE_SHEAR = 293;
    @Since("FUTURE") public static final int SOUND_DRINK_HONEY = 294;
    @Since("FUTURE") public static final int SOUND_AMBIENT_CAVE = 295;
    @Since("FUTURE") public static final int SOUND_RETREAT = 296;
    @Since("FUTURE") public static final int SOUND_CONVERTED_TO_ZOMBIFIED = 297;
    @Since("FUTURE") public static final int SOUND_ADMIRE = 298;
    @Since("FUTURE") public static final int SOUND_STEP_LAVA = 299;
    @Since("FUTURE") public static final int SOUND_TEMPT = 300;
    @Since("FUTURE") public static final int SOUND_PANIC = 301;
    @Since("FUTURE") public static final int SOUND_ANGRY = 302;
    @Since("FUTURE") public static final int SOUND_AMBIENT_WARPED_FOREST_MOOD = 303;
    @Since("FUTURE") public static final int SOUND_AMBIENT_SOULSAND_VALLEY_MOOD = 304;
    @Since("FUTURE") public static final int SOUND_AMBIENT_NETHER_WASTES_MOOD = 305;
    @Since("FUTURE") public static final int SOUND_RESPAWN_ANCHOR_BASALT_DELTAS_MOOD = 306;
    @Since("FUTURE") public static final int SOUND_AMBIENT_CRIMSON_FOREST_MOOD = 307;
    @Since("FUTURE") public static final int SOUND_RESPAWN_ANCHOR_CHARGE = 308;
    @Since("FUTURE") public static final int SOUND_RESPAWN_ANCHOR_DEPLETE = 309;
    @Since("FUTURE") public static final int SOUND_RESPAWN_ANCHOR_SET_SPAWN = 310;
    @Since("FUTURE") public static final int SOUND_RESPAWN_ANCHOR_AMBIENT = 311;
    @Since("FUTURE") public static final int SOUND_PARTICLE_SOUL_ESCAPE_QUIET = 312;
    @Since("FUTURE") public static final int SOUND_PARTICLE_SOUL_ESCAPE_LOUD = 313;
    @Since("1.4.0.0-PN") public static final int SOUND_RECORD_PIGSTEP = 314;
    @Since("FUTURE") public static final int SOUND_LODESTONE_COMPASS_LINK_COMPASS_TO_LODESTONE = 315;
    @Since("FUTURE") public static final int SOUND_SMITHING_TABLE_USE = 316;
    @Since("FUTURE") public static final int SOUND_ARMOR_EQUIP_NETHERITE = 317;
    @Since("FUTURE") public static final int SOUND_AMBIENT_WARPED_FOREST_LOOP = 318;
    @Since("FUTURE") public static final int SOUND_AMBIENT_SOULSAND_VALLEY_LOOP = 319;
    @Since("FUTURE") public static final int SOUND_AMBIENT_NETHER_WASTES_LOOP = 320;
    @Since("FUTURE") public static final int SOUND_AMBIENT_BASALT_DELTAS_LOOP = 321;
    @Since("FUTURE") public static final int SOUND_AMBIENT_CRIMSON_FOREST_LOOP = 322;
    @Since("FUTURE") public static final int SOUND_AMBIENT_WARPED_FOREST_ADDITIONS = 323;
    @Since("FUTURE") public static final int SOUND_AMBIENT_SOULSAND_VALLEY_ADDITIONS = 324;
    @Since("FUTURE") public static final int SOUND_AMBIENT_NETHER_WASTES_ADDITIONS = 325;
    @Since("FUTURE") public static final int SOUND_AMBIENT_BASALT_DELTAS_ADDITIONS = 326;
    @Since("FUTURE") public static final int SOUND_AMBIENT_CRIMSON_FOREST_ADDITIONS = 327;
    @Since("FUTURE") public static final int SOUND_SCULK_SENSOR_POWER_ON = 328;
    @Since("FUTURE") public static final int SOUND_SCULK_SENSOR_POWER_OFF = 329;
    @Since("FUTURE") public static final int SOUND_BUCKET_FILL_POWDER_SNOW = 330;
    @Since("FUTURE") public static final int SOUND_BUCKET_EMPTY_POWDER_SNOW = 331;
    @Since("FUTURE") public static final int SOUND_POINTED_DRIPSTONE_CAULDRON_DRIP_WATER = 332;
    @Since("FUTURE") public static final int SOUND_POINTED_DRIPSTONE_CAULDRON_DRIP_LAVA = 333;
    @Since("FUTURE") public static final int SOUND_POINTED_DRIPSTONE_DRIP_WATER = 334;
    @Since("FUTURE") public static final int SOUND_POINTED_DRIPSTONE_DRIP_LAVA = 335;
    @Since("FUTURE") public static final int SOUND_CAVE_VINES_PICK_BERRIES = 336;
    @Since("FUTURE") public static final int SOUND_BIG_DRIPLEAF_TILT_DOWN = 337;
    @Since("FUTURE") public static final int SOUND_BIG_DRIPLEAF_TILT_UP = 338;
    @Since("FUTURE") public static final int SOUND_COPPER_WAX_ON = 339;
    @Since("FUTURE") public static final int SOUND_COPPER_WAX_OFF = 340;
    @Since("FUTURE") public static final int SOUND_SCRAPE = 341;
    @Since("FUTURE") public static final int SOUND_PLAYER_HURT_DROWN = 342;
    @Since("FUTURE") public static final int SOUND_PLAYER_HURT_ON_FIRE = 343;
    @Since("FUTURE") public static final int SOUND_PLAYER_HURT_FREEZE = 344;
    @Since("FUTURE") public static final int SOUND_USE_SPYGLASS = 345;
    @Since("FUTURE") public static final int SOUND_STOP_USING_SPYGLASS = 346;
    @Since("FUTURE") public static final int SOUND_AMETHYST_BLOCK_CHIME = 347;
    @Since("FUTURE") public static final int SOUND_AMBIENT_SCREAMER = 348;
    @Since("FUTURE") public static final int SOUND_HURT_SCREAMER = 349;
    @Since("FUTURE") public static final int SOUND_DEATH_SCREAMER = 350;
    @Since("FUTURE") public static final int SOUND_MILK_SCREAMER = 351;
    @Since("FUTURE") public static final int SOUND_JUMP_TO_BLOCK = 352;
    @Since("FUTURE") public static final int SOUND_PRE_RAM = 353;
    @Since("FUTURE") public static final int SOUND_PRE_RAM_SCREAMER = 354;
    @Since("FUTURE") public static final int SOUND_RAM_IMPACT = 355;
    @Since("FUTURE") public static final int SOUND_RAM_IMPACT_SCREAMER = 356;
    @Since("FUTURE") public static final int SOUND_SQUID_INK_SQUIRT = 357;
    @Since("FUTURE") public static final int SOUND_GLOW_SQUID_INK_SQUIRT = 358;
    @Since("FUTURE") public static final int SOUND_CONVERT_TO_STRAY = 359;
    @Since("FUTURE") public static final int SOUND_CAKE_ADD_CANDLE = 360;
    @Since("FUTURE") public static final int SOUND_EXTINGUISH_CANDLE = 361;
    @Since("FUTURE") public static final int SOUND_AMBIENT_CANDLE = 362;
    @Since("FUTURE") public static final int SOUND_BLOCK_CLICK = 363;
    @Since("FUTURE") public static final int SOUND_BLOCK_CLICK_FAIL = 364;
    @Since("FUTURE") public static final int SOUND_SCULK_CATALYST_BLOOM = 365;
    @Since("FUTURE") public static final int SOUND_SCULK_SHRIEKER_SHRIEK = 366;
    @Since("FUTURE") public static final int SOUND_WARDEN_NEARBY_CLOSE = 367;
    @Since("FUTURE") public static final int SOUND_WARDEN_NEARBY_CLOSER = 368;
    @Since("FUTURE") public static final int SOUND_WARDEN_NEARBY_CLOSEST = 369;
    @Since("FUTURE") public static final int SOUND_WARDEN_SLIGHTLY_ANGRY = 370;
    @Since("FUTURE") public static final int SOUND_RECORD_OTHERSIDE = 371;
    @Since("FUTURE") public static final int SOUND_TONGUE = 372;
    @Since("FUTURE") public static final int SOUND_CRACK_IRON_GOLEM = 373;
    @Since("FUTURE") public static final int SOUND_REPAIR_IRON_GOLEM = 374;
    @Since("FUTURE") public static final int SOUND_UNDEFINED = 375;
