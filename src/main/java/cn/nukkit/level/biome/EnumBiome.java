...
public enum EnumBiome {
    ...
    // Nether Biomes
    NETHER_WASTES(201, new NetherWastes()),
    SOUL_SAND_VALLEY(202, new SoulSandValley()),
    CRIMSON_FOREST(203, new CrimsonForest()),
    WARPED_FOREST(204, new WarpedForest()),
    BASALT_DELTAS(205, new BasaltDeltas());
