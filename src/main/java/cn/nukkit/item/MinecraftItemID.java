...
public enum MinecraftItemID {
    ...
    @PowerNukkitOnly @Since("1.4.0.0-PN") INVISIBLE_BEDROCK(false, true),
    ...
    @PowerNukkitOnly @Since("1.4.0.0-PN") TRIP_WIRE(false, true),
    ...
    @PowerNukkitOnly @Since("1.4.0.0-PN") SEA_LANTERN,
    ...
    @PowerNukkitOnly @Since("1.4.0.0-PN") CONCRETE_POWDER,
    ...
    @PowerNukkitOnly @Since("1.4.0.0-PN") MUSIC_DISC_OTHERSIDE,
    ...
    @PowerNukkitOnly @Since("FUTURE") BLACK_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") RED_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") GREEN_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") BROWN_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") BLUE_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") PURPLE_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") CYAN_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") LIGHT_GRAY_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") GRAY_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") PINK_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") LIME_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") YELLOW_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") LIGHT_BLUE_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") MAGENTA_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") ORANGE_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") WHITE_CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") CANDLE_CAKE,
    @PowerNukkitOnly @Since("FUTURE") BLACK_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") RED_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") GREEN_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") BROWN_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") BLUE_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") PURPLE_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") CYAN_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") LIGHT_GRAY_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") GRAY_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") PINK_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") LIME_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") YELLOW_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") LIGHT_BLUE_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") MAGENTA_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") ORANGE_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") WHITE_CANDLE,
    @PowerNukkitOnly @Since("FUTURE") CANDLE,
    ...
    @PowerNukkitOnly @Since("FUTURE") GLOBE_BANNER_PATTERN,
    ...
    @PowerNukkitOnly @Since("FUTURE") MANGROVE_PROPAGULE,
    @PowerNukkitOnly @Since("FUTURE") MANGROVE_ROOTS,
    @PowerNukkitOnly @Since("FUTURE") MANGROVE_WOOD,
    @PowerNukkitOnly @Since("FUTURE") MANGROVE_MUD,
    @PowerNukkitOnly @Since("FUTURE") MANGROVE_MUD_BRICKS,
    @PowerNukkitOnly @Since("FUTURE") MANGROVE_MUDDY_MANGROVE_ROOTS,
    @PowerNukkitOnly @Since("FUTURE") PACKED_MUD,
    @PowerNukkitOnly @Since("FUTURE") REINFORCED_DEEPSLATE,
    @PowerNukkitOnly @Since("FUTURE") SCULK,
    @PowerNukkitOnly @Since("FUTURE") SCULK_CATALYST,
    @PowerNukkitOnly @Since("FUTURE") SCULK_SHRIEKER,
    @PowerNukkitOnly @Since("FUTURE") SCULK_VEIN,
    @PowerNukkitOnly @Since("FUTURE") TADPOLE_BUCKET,
    @PowerNukkitOnly @Since("FUTURE") DISC_FRAGMENT_5,
    @PowerNukkitOnly @Since("FUTURE") ECHO_SHARD,
    @PowerNukkitOnly @Since("FUTURE") MANGROVE_BOAT,
    @PowerNukkitOnly @Since("FUTURE") MUSIC_DISC_5,
    @PowerNukkitOnly @Since("FUTURE") RECOVERY_COMPASS,
    @PowerNukkitOnly @Since("FUTURE") ALLAY_SPAWN_EGG,
    @PowerNukkitOnly @Since("FUTURE") FROG_SPAWN_EGG,
    @PowerNukkitOnly @Since("FUTURE") TADPOLE_SPAWN_EGG,
    @PowerNukkitOnly @Since("FUTURE") WARDEN_SPAWN_EGG,
    ;
