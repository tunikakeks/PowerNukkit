...
public class MoveEntityDeltaPacket extends DataPacket {
    ...
    @Since("1.6.0.0-PN") public static final int FLAG_ON_GROUND = 0B1000000;
    @Since("1.6.0.0-PN") public static final int FLAG_TELEPORTING = 0B10000000;
    @Since("1.6.0.0-PN") public static final int FLAG_FORCE_MOVE_LOCAL_ENTITY = 0B100000000;

    @Since("1.6.0.0-PN") public long runtimeEntityId;
    public int flags = 0;
    @Since("1.4.0.0-PN") public float x = 0;
    @Since("1.4.0.0-PN") public float y = 0;
    @Since("1.4.0.0-PN") public float z = 0;
    @Since("1.6.0.0-PN") public float pitch = 0;
    @Since("1.6.0.0-PN") public float yaw = 0;
    @Since("1.6.0.0-PN") public float headYaw = 0;
