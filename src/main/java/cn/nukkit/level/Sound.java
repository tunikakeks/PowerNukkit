...
public enum Sound {
    ...
    @Since("1.6.0.0-PN") BREAK_AMETHYST_BLOCK("break.amethyst_block"),
    @Since("1.6.0.0-PN") BREAK_AMETHYST_CLUSTER("break.amethyst_cluster"),
    @Since("1.6.0.0-PN") BREAK_AZALEA("break.azalea"),
    @Since("1.6.0.0-PN") BREAK_BIG_DRIPLEAF("break.big_dripleaf"),
    @Since("1.6.0.0-PN") BREAK_CALCITE("break.calcite"),
    @Since("1.6.0.0-PN") BREAK_DIRT_WITH_ROOTS("break.dirt_with_roots"),
    @Since("1.6.0.0-PN") BREAK_DRIPSTONE_BLOCK("break.dripstone_block"),
    @Since("1.6.0.0-PN") BREAK_HANGING_ROOTS("break.hanging_roots"),
    @Since("1.6.0.0-PN") BREAK_LARGE_AMETHYST_BUD("break.large_amethyst_bud"),
    @Since("1.6.0.0-PN") BREAK_MEDIUM_AMETHYST_BUD("break.medium_amethyst_bud"),
    @Since("1.6.0.0-PN") BREAK_POINTED_DRIPSTONE("break.pointed_dripstone"),
    @Since("1.6.0.0-PN") BREAK_SMALL_AMETHYST_BUD("break.small_amethyst_bud"),
    @Since("1.6.0.0-PN") BREAK_SPORE_BLOSSOM("break.spore_blossom"),
    @Since("1.6.0.0-PN") BREAK_TUFF("break.tuff"),
    ...
    @Since("1.6.0.0-PN") CAULDRON_DRIP_LAVA_POINTED_DRIPSTONE("cauldron_drip.lava.pointed_dripstone"),
    @Since("1.6.0.0-PN") CAULDRON_DRIP_WATER_POINTED_DRIPSTONE("cauldron_drip.water.pointed_dripstone"),
    @Since("1.6.0.0-PN") CHIME_AMETHYST_BLOCK("chime.amethyst_block"),
    @Since("1.6.0.0-PN") COMPONENT_JUMP_TO_BLOCK("component.jump_to_block"),
    ...
    @Since("1.6.0.0-PN") HIT_AMETHYST_BLOCK("hit.amethyst_block"),
    @Since("1.6.0.0-PN") HIT_AMETHYST_CLUSTER("hit.amethyst_cluster"),
    ...
    @Since("1.6.0.0-PN") ITEM_BONE_MEAL_USE("item.bone_meal.use"),
    ...
    @Since("1.6.0.0-PN") MOB_GLOW_SQUID_AMBIENT("mob.glow_squid.ambient"),
    @Since("1.6.0.0-PN") MOB_GLOW_SQUID_DEATH("mob.glow_squid.death"),
    @Since("1.6.0.0-PN") MOB_GLOW_SQUID_HURT("mob.glow_squid.hurt"),
    @Since("1.6.0.0-PN") MOB_GLOW_SQUID_INK_SQUIRT("mob.glow_squid.ink_squirt"),
    @Since("1.6.0.0-PN") MOB_GOAT_AMBIENT("mob.goat.ambient"),
    @Since("1.6.0.0-PN") MOB_GOAT_AMBIENT_SCREAMER("mob.goat.ambient.screamer"),
    @Since("1.6.0.0-PN") MOB_GOAT_DEATH("mob.goat.death"),
    @Since("1.6.0.0-PN") MOB_GOAT_DEATH_SCREAMER("mob.goat.death.screamer"),
    @Since("1.6.0.0-PN") MOB_GOAT_EAT("mob.goat.eat"),
    @Since("1.6.0.0-PN") MOB_GOAT_HURT("mob.goat.hurt"),
    @Since("1.6.0.0-PN") MOB_GOAT_HURT_SCREAMER("mob.goat.hurt.screamer"),
    @Since("1.6.0.0-PN") MOB_GOAT_MILK_SCREAMER("mob.goat.milk.screamer"),
    @Since("1.6.0.0-PN") MOB_GOAT_PREPARE_RAM("mob.goat.prepare_ram"),
    @Since("1.6.0.0-PN") MOB_GOAT_PREPARE_RAM_SCREAMER("mob.goat.prepare_ram.screamer"),
    @Since("1.6.0.0-PN") MOB_GOAT_RAM_IMPACT("mob.goat.ram_impact"),
    @Since("1.6.0.0-PN") MOB_GOAT_RAM_IMPACT_SCREAMER("mob.goat.ram_impact.screamer"),
    @Since("1.6.0.0-PN") MOB_GOAT_STEP("mob.goat.step"),
    ...
    @Since("1.6.0.0-PN") MUSIC_GAME_DRIPSTONE_CAVES("music.game.dripstone_caves"),
    ...
    @Since("1.6.0.0-PN") MUSIC_GAME_STONY_PEAKS("music.game.stony_peaks"),
    MUSIC_GAME_SWAMP_MUSIC("music.game.swamp_music"),
    @Since("1.6.0.0-PN") MUSIC_GAME_WARPED_FOREST("music.game.warped_forest"),
    ...
    @Since("1.6.0.0-PN") PICK_BERRIES_CAVE_VINES("pick_berries.cave_vines"),
    @Since("1.6.0.0-PN") PLACE_AMETHYST_BLOCK("place.amethyst_block"),
    @Since("1.6.0.0-PN") PLACE_AMETHYST_CLUSTER("place.amethyst_cluster"),
    @Since("1.6.0.0-PN") PLACE_AZALEA("place.azalea"),
    @Since("1.6.0.0-PN") PLACE_AZALEA_LEAVES("place.azalea_leaves"),
    @Since("1.6.0.0-PN") PLACE_BIG_DRIPLEAF("place.big_dripleaf"),
    @Since("1.6.0.0-PN") PLACE_CALCITE("place.calcite"),
    @Since("1.6.0.0-PN") PLACE_COPPER("place.copper"),
    @Since("1.6.0.0-PN") PLACE_DEEPSLATE("place.deepslate"),
    @Since("1.6.0.0-PN") PLACE_DEEPSLATE_BRICKS("place.deepslate_bricks"),
    @Since("1.6.0.0-PN") PLACE_DIRT_WITH_ROOTS("place.dirt_with_roots"),
    @Since("1.6.0.0-PN") PLACE_DRIPSTONE_BLOCK("place.dripstone_block"),
    @Since("1.6.0.0-PN") PLACE_HANGING_ROOTS("place.hanging_roots"),
    @Since("1.6.0.0-PN") PLACE_LARGE_AMETHYST_BUD("place.large_amethyst_bud"),
    @Since("1.6.0.0-PN") PLACE_MEDIUM_AMETHYST_BUD("place.medium_amethyst_bud"),
    @Since("1.6.0.0-PN") PLACE_MOSS("place.moss"),
    @Since("1.6.0.0-PN") PLACE_POINTED_DRIPSTONE("place.pointed_dripstone"),
    @Since("1.6.0.0-PN") PLACE_POWDER_SNOW("place.powder_snow"),
    ...
    @Since("1.6.0.0-PN") PLACE_SMALL_AMETHYST_BUD("place.small_amethyst_bud"),
    @Since("1.6.0.0-PN") PLACE_SPORE_BLOSSOM("place.spore_blossom"),
    @Since("1.6.0.0-PN") PLACE_TUFF("place.tuff"),
    ...
    @Since("1.6.0.0-PN") RECORD_OTHERSIDE("record.otherside"),
    ...
    @Since("1.6.0.0-PN") SCRAPE("scrape"),
    ...
    @Since("1.6.0.0-PN") STEP_AMETHYST_BLOCK("step.amethyst_block"),
    @Since("1.6.0.0-PN") STEP_AMETHYST_CLUSTER("step.amethyst_cluster"),
    ...
    @Since("1.6.0.0-PN") STEP_DEEPSLATE("step.deepslate"),
    @Since("1.6.0.0-PN") STEP_DEEPSLATE_BRICKS("step.deepslate_bricks"),
    @Since("1.6.0.0-PN") STEP_DIRT_WITH_ROOTS("step.dirt_with_roots"),
    @Since("1.6.0.0-PN") STEP_DRIPSTONE_BLOCK("step.dripstone_block"),
