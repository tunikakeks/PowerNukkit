...
public class SmithingInventory extends FakeBlockUIComponent {
    ...
    public void onSlotChange(int index, Item before, boolean send) {
        try {
            ...
            if (!inputItem.isNull() && !materialItem.isNull() && (getNetheriteResult(inputItem).getId() == 0) && materialItem.getId() != ItemID.NETHERITE_INGOT) {
    ...
    public Item getNetheriteResult(Item before) {
        ...
        if (before.getId() == ItemID.DIAMOND_HELMET) return Item.get(ItemID.NETHERITE_HELMET);
