...
public enum Sound {
    ...
    @Since("FUTURE") AMBIENT_CANDLE("ambient.candle"),
    ...
    @Since("FUTURE") BLOCK_BOWHIT("block.bowhit"),
    ...
    @Since("FUTURE") BLOCK_CLICK("block.click"),
    ...
    @Since("FUTURE") BREAK_AMETHYST_BLOCK("break.amethyst_block"),
    @Since("FUTURE") BREAK_AMETHYST_CLUSTER("break.amethyst_cluster"),
    @Since("FUTURE") BREAK_AZALEA("break.azalea"),
    @Since("FUTURE") BREAK_BIG_DRIPLEAF("break.big_dripleaf"),
    @Since("FUTURE") BREAK_CALCITE("break.calcite"),
    @Since("FUTURE") BREAK_DIRT_WITH_ROOTS("break.dirt_with_roots"),
    @Since("FUTURE") BREAK_DRIPSTONE_BLOCK("break.dripstone_block"),
    @Since("FUTURE") BREAK_HANGING_ROOTS("break.hanging_roots"),
    @Since("FUTURE") BREAK_LARGE_AMETHYST_BUD("break.large_amethyst_bud"),
    @Since("FUTURE") BREAK_MEDIUM_AMETHYST_BUD("break.medium_amethyst_bud"),
    @Since("FUTURE") BREAK_POINTED_DRIPSTONE("break.pointed_dripstone"),
    @Since("FUTURE") BREAK_SMALL_AMETHYST_BUD("break.small_amethyst_bud"),
    @Since("FUTURE") BREAK_SPORE_BLOSSOM("break.spore_blossom"),
    @Since("FUTURE") BREAK_TUFF("break.tuff"),
    ...
    @Since("FUTURE") BUCKET_EMPTY_POWDER_SNOW("bucket.empty_powder_snow"),
    BUCKET_EMPTY_WATER("bucket.empty_water"),
    BUCKET_FILL_FISH("bucket.fill_fish"),
    BUCKET_FILL_LAVA("bucket.fill_lava"),
    @Since("FUTURE") BUCKET_FILL_POWDER_SNOW("bucket.fill_powder_snow"),
    BUCKET_FILL_WATER("bucket.fill_water"),
    @Since("FUTURE") CAKE_ADD_CANDLE("cake.add_candle"),
    ...
    @Since("FUTURE") CAULDRON_DRIP_LAVA_POINTED_DRIPSTONE("cauldron_drip.lava.pointed_dripstone"),
    @Since("FUTURE") CAULDRON_DRIP_WATER_POINTED_DRIPSTONE("cauldron_drip.water.pointed_dripstone"),
    @Since("FUTURE") CHIME_AMETHYST_BLOCK("chime.amethyst_block"),
    @Since("FUTURE") COMPONENT_JUMP_TO_BLOCK("component.jump_to_block"),
    ...
    @Since("FUTURE") COPPER_WAX_OFF("copper.wax.off"),
    @Since("FUTURE") COPPER_WAX_ON("copper.wax.on"),
    ...
    @Since("FUTURE") DIG_AZALEA_LEAVES("dig.azalea_leaves"),
    DIG_BASALT("dig.basalt"),
    DIG_BONE_BLOCK("dig.bone_block"),
    @Since("FUTURE") DIG_CANDLE("dig.candle"),
    @Since("FUTURE") DIG_CAVE_VINES("dig.cave_vines"),
    DIG_CHAIN("dig.chain"),
    DIG_CLOTH("dig.cloth"),
    @Since("FUTURE") DIG_COPPER("dig.copper"),
    DIG_CORAL("dig.coral"),
    @Since("FUTURE") DIG_DEEPSLATE("dig.deepslate"),
    @Since("FUTURE") DIG_DEEPSLATE_BRICKS("dig.deepslate_bricks"),
    DIG_FUNGUS("dig.fungus"),
    DIG_GRASS("dig.grass"),
    DIG_GRAVEL("dig.gravel"),
    DIG_HONEY_BLOCK("dig.honey_block"),
    DIG_LODESTONE("dig.lodestone"),
    @Since("FUTURE") DIG_MOSS("dig.moss"),
    ...
    @Since("FUTURE") DIG_POWDER_SNOW("dig.powder_snow"),
    DIG_ROOTS("dig.roots"),
    DIG_SAND("dig.sand"),
    ...
    @Since("FUTURE") FALL_AMETHYST_BLOCK("fall.amethyst_block"),
    @Since("FUTURE") FALL_AMETHYST_CLUSTER("fall.amethyst_cluster"),
    FALL_ANCIENT_DEBRIS("fall.ancient_debris"),
    @Since("FUTURE") FALL_AZALEA("fall.azalea"),
    @Since("FUTURE") FALL_AZALEA_LEAVES("fall.azalea_leaves"),
    FALL_BASALT("fall.basalt"),
    @Since("FUTURE") FALL_BIG_DRIPLEAF("fall.big_dripleaf"),
    FALL_BONE_BLOCK("fall.bone_block"),
    @Since("FUTURE") FALL_CALCITE("fall.calcite"),
    @Since("FUTURE") FALL_CAVE_VINES("fall.cave_vines"),
    FALL_CHAIN("fall.chain"),
    FALL_CLOTH("fall.cloth"),
    @Since("FUTURE") FALL_COPPER("fall.copper"),
    FALL_CORAL("fall.coral"),
    @Since("FUTURE") FALL_DEEPSLATE("fall.deepslate"),
    @Since("FUTURE") FALL_DEEPSLATE_BRICKS("fall.deepslate_bricks"),
    @Since("FUTURE") FALL_DIRT_WITH_ROOTS("fall.dirt_with_roots"),
    @Since("FUTURE") FALL_DRIPSTONE_BLOCK("fall.dripstone_block"),
    FALL_EGG("fall.egg"),
    FALL_GRASS("fall.grass"),
    FALL_GRAVEL("fall.gravel"),
    @Since("FUTURE") FALL_HANGING_ROOTS("fall.hanging_roots"),
    FALL_HONEY_BLOCK("fall.honey_block"),
    FALL_LADDER("fall.ladder"),
    @Since("FUTURE") FALL_MOSS("fall.moss"),
    ...
    @Since("FUTURE") FALL_POINTED_DRIPSTONE("fall.pointed_dripstone"),
    @Since("FUTURE") FALL_POWDER_SNOW("fall.powder_snow"),
    ...
    @Since("FUTURE") FALL_SPORE_BLOSSOM("fall.spore_blossom"),
    FALL_STEM("fall.stem"),
    FALL_STONE("fall.stone"),
    @Since("FUTURE") FALL_TUFF("fall.tuff"),
    ...
    @Since("FUTURE") HIT_AMETHYST_BLOCK("hit.amethyst_block"),
    @Since("FUTURE") HIT_AMETHYST_CLUSTER("hit.amethyst_cluster"),
    HIT_ANCIENT_DEBRIS("hit.ancient_debris"),
    HIT_ANVIL("hit.anvil"),
    @Since("FUTURE") HIT_AZALEA("hit.azalea"),
    @Since("FUTURE") HIT_AZALEA_LEAVES("hit.azalea_leaves"),
    HIT_BASALT("hit.basalt"),
    @Since("FUTURE") HIT_BIG_DRIPLEAF("hit.big_dripleaf"),
    HIT_BONE_BLOCK("hit.bone_block"),
    @Since("FUTURE") HIT_CALCITE("hit.calcite"),
    @Since("FUTURE") HIT_CANDLE("hit.candle"),
    @Since("FUTURE") HIT_CAVE_VINES("hit.cave_vines"),
    HIT_CHAIN("hit.chain"),
    HIT_CLOTH("hit.cloth"),
    @Since("FUTURE") HIT_COPPER("hit.copper"),
    HIT_CORAL("hit.coral"),
    @Since("FUTURE") HIT_DEEPSLATE("hit.deepslate"),
    @Since("FUTURE") HIT_DEEPSLATE_BRICKS("hit.deepslate_bricks"),
    @Since("FUTURE") HIT_DIRT_WITH_ROOTS("hit.dirt_with_roots"),
    @Since("FUTURE") HIT_DRIPSTONE_BLOCK("hit.dripstone_block"),
    HIT_GRASS("hit.grass"),
    HIT_GRAVEL("hit.gravel"),
    @Since("FUTURE") HIT_HANGING_ROOTS("hit.hanging_roots"),
    HIT_HONEY_BLOCK("hit.honey_block"),
    HIT_LADDER("hit.ladder"),
    @Since("FUTURE") HIT_MOSS("hit.moss"),
    ...
    @Since("FUTURE") HIT_POINTED_DRIPSTONE("hit.pointed_dripstone"),
    @Since("FUTURE") HIT_POWDER_SNOW("hit.powder_snow"),
    HIT_ROOTS("hit.roots"),
    HIT_SAND("hit.sand"),
    ...
    @Since("FUTURE") HIT_SPORE_BLOSSOM("hit.spore_blossom"),
    HIT_STEM("hit.stem"),
    HIT_STONE("hit.stone"),
    @Since("FUTURE") HIT_TUFF("hit.tuff"),
    HIT_VINES("hit.vines"),
    HIT_WOOD("hit.wood"),
    @Since("FUTURE") ITEM_BONE_MEAL_USE("item.bone_meal.use"),
    ITEM_BOOK_PAGE_TURN("item.book.page_turn"),
    ITEM_BOOK_PUT("item.book.put"),
    ITEM_SHIELD_BLOCK("item.shield.block"),
    @Since("FUTURE") ITEM_SPYGLASS_STOP_USING("item.spyglass.stop_using"),
    @Since("FUTURE") ITEM_SPYGLASS_USE("item.spyglass.use"),
    ...
    @Since("FUTURE") JUMP_AZALEA("jump.azalea"),
    JUMP_BASALT("jump.basalt"),
    @Since("FUTURE") JUMP_BIG_DRIPLEAF("jump.big_dripleaf"),
    JUMP_BONE_BLOCK("jump.bone_block"),
    @Since("FUTURE") JUMP_CAVE_VINES("jump.cave_vines"),
    JUMP_CHAIN("jump.chain"),
    JUMP_CLOTH("jump.cloth"),
    JUMP_CORAL("jump.coral"),
    @Since("FUTURE") JUMP_DEEPSLATE("jump.deepslate"),
    @Since("FUTURE") JUMP_DEEPSLATE_BRICKS("jump.deepslate_bricks"),
    @Since("FUTURE") JUMP_DIRT_WITH_ROOTS("jump.dirt_with_roots"),
    @Since("FUTURE") JUMP_DRIPSTONE_BLOCK("jump.dripstone_block"),
    JUMP_GRASS("jump.grass"),
    JUMP_GRAVEL("jump.gravel"),
    @Since("FUTURE") JUMP_HANGING_ROOTS("jump.hanging_roots"),
    JUMP_HONEY_BLOCK("jump.honey_block"),
    @Since("FUTURE") JUMP_MOSS("jump.moss"),
    ...
    @Since("FUTURE") JUMP_POINTED_DRIPSTONE("jump.pointed_dripstone"),
    ...
    @Since("FUTURE") JUMP_SPORE_BLOSSOM("jump.spore_blossom"),
    JUMP_STEM("jump.stem"),
    JUMP_STONE("jump.stone"),
    JUMP_VINES("jump.vines"),
    JUMP_WOOD("jump.wood"),
    LAND_ANCIENT_DEBRIS("land.ancient_debris"),
    @Since("FUTURE") LAND_AZALEA("land.azalea"),
    LAND_BASALT("land.basalt"),
    @Since("FUTURE") LAND_BIG_DRIPLEAF("land.big_dripleaf"),
    LAND_BONE_BLOCK("land.bone_block"),
    @Since("FUTURE") LAND_CAVE_VINES("land.cave_vines"),
    LAND_CHAIN("land.chain"),
    LAND_CLOTH("land.cloth"),
    LAND_CORAL("land.coral"),
    @Since("FUTURE") LAND_DEEPSLATE("land.deepslate"),
    @Since("FUTURE") LAND_DEEPSLATE_BRICKS("land.deepslate_bricks"),
    @Since("FUTURE") LAND_DIRT_WITH_ROOTS("land.dirt_with_roots"),
    @Since("FUTURE") LAND_DRIPSTONE_BLOCK("land.dripstone_block"),
    LAND_GRASS("land.grass"),
    LAND_GRAVEL("land.gravel"),
    @Since("FUTURE") LAND_HANGING_ROOTS("land.hanging_roots"),
    LAND_HONEY_BLOCK("land.honey_block"),
    @Since("FUTURE") LAND_MOSS("land.moss"),
    ...
    @Since("FUTURE") LAND_POINTED_DRIPSTONE("land.pointed_dripstone"),
    ...
    @Since("FUTURE") LAND_SPORE_BLOSSOM("land.spore_blossom"),
    LAND_STEM("land.stem"),
    ...
    @Since("FUTURE") MOB_AXOLOTL_ATTACK("mob.axolotl.attack"),
    @Since("FUTURE") MOB_AXOLOTL_DEATH("mob.axolotl.death"),
    @Since("FUTURE") MOB_AXOLOTL_HURT("mob.axolotl.hurt"),
    @Since("FUTURE") MOB_AXOLOTL_IDLE("mob.axolotl.idle"),
    @Since("FUTURE") MOB_AXOLOTL_IDLE_WATER("mob.axolotl.idle_water"),
    @Since("FUTURE") MOB_AXOLOTL_SPLASH("mob.axolotl.splash"),
    @Since("FUTURE") MOB_AXOLOTL_SWIM("mob.axolotl.swim"),
    ...
    @Since("FUTURE") MOB_GLOW_SQUID_AMBIENT("mob.glow_squid.ambient"),
    @Since("FUTURE") MOB_GLOW_SQUID_DEATH("mob.glow_squid.death"),
    @Since("FUTURE") MOB_GLOW_SQUID_HURT("mob.glow_squid.hurt"),
    @Since("FUTURE") MOB_GLOW_SQUID_INK_SQUIRT("mob.glow_squid.ink_squirt"),
    @Since("FUTURE") MOB_GOAT_AMBIENT("mob.goat.ambient"),
    @Since("FUTURE") MOB_GOAT_AMBIENT_SCREAMER("mob.goat.ambient.screamer"),
    @Since("FUTURE") MOB_GOAT_DEATH("mob.goat.death"),
    @Since("FUTURE") MOB_GOAT_DEATH_SCREAMER("mob.goat.death.screamer"),
    @Since("FUTURE") MOB_GOAT_EAT("mob.goat.eat"),
    @Since("FUTURE") MOB_GOAT_HURT("mob.goat.hurt"),
    @Since("FUTURE") MOB_GOAT_HURT_SCREAMER("mob.goat.hurt.screamer"),
    @Since("FUTURE") MOB_GOAT_MILK_SCREAMER("mob.goat.milk.screamer"),
    @Since("FUTURE") MOB_GOAT_PREPARE_RAM("mob.goat.prepare_ram"),
    @Since("FUTURE") MOB_GOAT_PREPARE_RAM_SCREAMER("mob.goat.prepare_ram.screamer"),
    @Since("FUTURE") MOB_GOAT_RAM_IMPACT("mob.goat.ram_impact"),
    @Since("FUTURE") MOB_GOAT_RAM_IMPACT_SCREAMER("mob.goat.ram_impact.screamer"),
    @Since("FUTURE") MOB_GOAT_STEP("mob.goat.step"),
    ...
    @Since("FUTURE") MOB_PLAYER_HURT_DROWN("mob.player.hurt_drown"),
    @Since("FUTURE") MOB_PLAYER_HURT_FREEZE("mob.player.hurt_freeze"),
    @Since("FUTURE") MOB_PLAYER_HURT_ON_FIRE("mob.player.hurt_on_fire"),
    ...
    @Since("FUTURE") MOB_SKELETON_CONVERT_TO_STRAY("mob.skeleton.convert_to_stray"),
    ...
    @Since("FUTURE") MOB_SQUID_INK_SQUIRT("mob.squid.ink_squirt"),
    ...
    @Since("FUTURE") MUSIC_GAME_BASALT_DELTAS("music.game.basalt_deltas"),
    ...
    @Since("FUTURE") MUSIC_GAME_DRIPSTONE_CAVES("music.game.dripstone_caves"),
    MUSIC_GAME_END("music.game.end"),
    MUSIC_GAME_ENDBOSS("music.game.endboss"),
    @Since("FUTURE") MUSIC_GAME_FROZEN_PEAKS("music.game.frozen_peaks"),
    @Since("FUTURE") MUSIC_GAME_GROVE("music.game.grove"),
    @Since("FUTURE") MUSIC_GAME_JAGGED_PEAKS("music.game.jagged_peaks"),
    @Since("FUTURE") MUSIC_GAME_LUSH_CAVES("music.game.lush_caves"),
    @Since("FUTURE") MUSIC_GAME_MEADOW("music.game.meadow"),
    MUSIC_GAME_NETHER("music.game.nether"),
    MUSIC_GAME_NETHER_WASTES("music.game.nether_wastes"),
    @Since("FUTURE") MUSIC_GAME_SNOWY_SLOPES("music.game.snowy_slopes"),
    @Since("FUTURE") MUSIC_GAME_SOUL_SAND_VALLEY("music.game.soul_sand_valley"),
    MUSIC_GAME_SOULSAND_VALLEY("music.game.soulsand_valley"),
    @Since("FUTURE") MUSIC_GAME_STONY_PEAKS("music.game.stony_peaks"),
    @Since("FUTURE") MUSIC_GAME_WARPED_FOREST("music.game.warped_forest"),
    ...
    @Since("FUTURE") PICK_BERRIES_CAVE_VINES("pick_berries.cave_vines"),
    @Since("FUTURE") PLACE_AMETHYST_BLOCK("place.amethyst_block"),
    @Since("FUTURE") PLACE_AMETHYST_CLUSTER("place.amethyst_cluster"),
    @Since("FUTURE") PLACE_AZALEA("place.azalea"),
    @Since("FUTURE") PLACE_AZALEA_LEAVES("place.azalea_leaves"),
    @Since("FUTURE") PLACE_BIG_DRIPLEAF("place.big_dripleaf"),
    @Since("FUTURE") PLACE_CALCITE("place.calcite"),
    @Since("FUTURE") PLACE_COPPER("place.copper"),
    @Since("FUTURE") PLACE_DEEPSLATE("place.deepslate"),
    @Since("FUTURE") PLACE_DEEPSLATE_BRICKS("place.deepslate_bricks"),
    @Since("FUTURE") PLACE_DIRT_WITH_ROOTS("place.dirt_with_roots"),
    @Since("FUTURE") PLACE_DRIPSTONE_BLOCK("place.dripstone_block"),
    @Since("FUTURE") PLACE_HANGING_ROOTS("place.hanging_roots"),
    @Since("FUTURE") PLACE_LARGE_AMETHYST_BUD("place.large_amethyst_bud"),
    @Since("FUTURE") PLACE_MEDIUM_AMETHYST_BUD("place.medium_amethyst_bud"),
    @Since("FUTURE") PLACE_MOSS("place.moss"),
    @Since("FUTURE") PLACE_POINTED_DRIPSTONE("place.pointed_dripstone"),
    @Since("FUTURE") PLACE_POWDER_SNOW("place.powder_snow"),
    @Since("FUTURE") PLACE_SMALL_AMETHYST_BUD("place.small_amethyst_bud"),
    @Since("FUTURE") PLACE_SPORE_BLOSSOM("place.spore_blossom"),
    @Since("FUTURE") PLACE_TUFF("place.tuff"),
    ...
    @Since("FUTURE") STEP_AMETHYST_BLOCK("step.amethyst_block"),
    @Since("FUTURE") STEP_AMETHYST_CLUSTER("step.amethyst_cluster"),
    STEP_ANCIENT_DEBRIS("step.ancient_debris"),
    @Since("FUTURE") STEP_AZALEA("step.azalea"),
    @Since("FUTURE") STEP_AZALEA_LEAVES("step.azalea_leaves"),
    STEP_BASALT("step.basalt"),
    @Since("FUTURE") STEP_BIG_DRIPLEAF("step.big_dripleaf"),
    STEP_BONE_BLOCK("step.bone_block"),
    @Since("FUTURE") STEP_CALCITE("step.calcite"),
    @Since("FUTURE") STEP_CANDLE("step.candle"),
    @Since("FUTURE") STEP_CAVE_VINES("step.cave_vines"),
    STEP_CHAIN("step.chain"),
    STEP_CLOTH("step.cloth"),
    @Since("FUTURE") STEP_COPPER("step.copper"),
    STEP_CORAL("step.coral"),
    @Since("FUTURE") STEP_DEEPSLATE("step.deepslate"),
    @Since("FUTURE") STEP_DEEPSLATE_BRICKS("step.deepslate_bricks"),
    @Since("FUTURE") STEP_DIRT_WITH_ROOTS("step.dirt_with_roots"),
    @Since("FUTURE") STEP_DRIPSTONE_BLOCK("step.dripstone_block"),
    STEP_GRASS("step.grass"),
    STEP_GRAVEL("step.gravel"),
    @Since("FUTURE") STEP_HANGING_ROOTS("step.hanging_roots"),
    STEP_HONEY_BLOCK("step.honey_block"),
    STEP_LADDER("step.ladder"),
    @Since("FUTURE") STEP_MOSS("step.moss"),
    ...
    @Since("FUTURE") STEP_POINTED_DRIPSTONE("step.pointed_dripstone"),
    @Since("FUTURE") STEP_POWDER_SNOW("step.powder_snow"),
    ...
    @Since("FUTURE") STEP_SPORE_BLOSSOM("step.spore_blossom"),
    STEP_STEM("step.stem"),
    STEP_STONE("step.stone"),
    @Since("FUTURE") STEP_TUFF("step.tuff"),
    STEP_VINES("step.vines"),
    STEP_WOOD("step.wood"),
    TILE_PISTON_IN("tile.piston.in"),
    TILE_PISTON_OUT("tile.piston.out"),
    @Since("FUTURE") TILT_DOWN_BIG_DRIPLEAF("tilt_down.big_dripleaf"),
    @Since("FUTURE") TILT_UP_BIG_DRIPLEAF("tilt_up.big_dripleaf"),
    ...
    @Since("FUTURE") USE_CANDLE("use.candle"),
    @Since("FUTURE") USE_CAVE_VINES("use.cave_vines"),
    USE_CHAIN("use.chain"),
    USE_CLOTH("use.cloth"),
    @Since("FUTURE") USE_COPPER("use.copper"),
    USE_CORAL("use.coral"),
    @Since("FUTURE") USE_DEEPSLATE("use.deepslate"),
    @Since("FUTURE") USE_DEEPSLATE_BRICKS("use.deepslate_bricks"),
    @Since("FUTURE") USE_DIRT_WITH_ROOTS("use.dirt_with_roots"),
    @Since("FUTURE") USE_DRIPSTONE_BLOCK("use.dripstone_block"),
    USE_GRASS("use.grass"),
    USE_GRAVEL("use.gravel"),
    @Since("FUTURE") USE_HANGING_ROOTS("use.hanging_roots"),
    USE_HONEY_BLOCK("use.honey_block"),
    USE_LADDER("use.ladder"),
    @Since("FUTURE") USE_MOSS("use.moss"),
    ...
    @Since("FUTURE") USE_POINTED_DRIPSTONE("use.pointed_dripstone"),
    USE_ROOTS("use.roots"),
    USE_SAND("use.sand"),
    ...
    @Since("FUTURE") USE_SPORE_BLOSSOM("use.spore_blossom"),
    USE_STEM("use.stem"),
    USE_STONE("use.stone"),
    USE_VINES("use.vines"),
    USE_WOOD("use.wood"),
